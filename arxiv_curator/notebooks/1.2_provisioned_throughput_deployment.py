...
ENDPOINT_NAME = "llama-3-2-1b-provisioned-pralaygh"  # Your endpoint name
...
def wait_for_endpoint(endpoint_name: str, timeout_minutes: int = 30) -> bool | None:
    ...
    while True:
        try:
            ...
            # Endpoint is ready when config is NOT_UPDATING and ready is READY
            ...
            logger.info(
                "Tip: Check Databricks UI -> Machine Learning -> Serving"
