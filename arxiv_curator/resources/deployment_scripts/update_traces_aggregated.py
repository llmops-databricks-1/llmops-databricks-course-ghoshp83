...
traces_table = f"{catalog}.{schema}.trace_logs_2818293205791300"
aggregated_view = f"{catalog}.{schema}.arxiv_traces_aggregated_pg"
...
new_traces_df = spark.sql(f"""
    ...
    WHERE tags['model_serving_endpoint_name']
            = 'arxiv-agent-endpoint-dev-course-pg'
